...
New-Item -ItemType directory -Path "$VSP_INCLUDE_PATH/libfreenect" -Force >> $logFile
cp "..\include\*.h" "$VSP_INCLUDE_PATH/libfreenect" -force
cp "..\wrappers\c_sync\*.h" "$VSP_INCLUDE_PATH/libfreenect" -force
